...
class Bat:
    ...
    def detect_collision(self,ball,sides_sweet_spot=True, topnbottom_sweet_spot=False):
        ...
        if(collision):
            ...
            elif((top_b>top-r) and (bottom_b < bottom+r) and (right_b> right) and(left_b<=right)):
            ...
            if((topnbottom_sweet_spot==True) and (collision_diection=="N" or collision_direction=="S")):
